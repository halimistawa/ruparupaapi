...
GlobalVariable.accessToken = 'default'
GlobalVariable.minicartID = 'default'
...
responseGetMinicart = WS.sendRequest(findTestObject('API FLOW/minicart',[('minicartID'):GlobalVariable.minicartID,('authorization'):GlobalVariable.accessToken]))
...
//String getError = resultGetMinicart.errors.isEmpty().toString()
//def resultError = resultGetMinicart.error
//String getData = resultGetMinicart.data.toString()
int totalQty = 0
int totalSKU = 0
