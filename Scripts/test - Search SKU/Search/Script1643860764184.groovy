...
//GlobalVariable.sku = 10179909  //10050304 //10179909 
responseSearchSKU = WS.sendRequest(findTestObject('API Login/searchSKU'))

def getName = new groovy.json.JsonSlurper()

def resultName = getName.parseText(responseSearchSKU.getResponseBodyContent())
